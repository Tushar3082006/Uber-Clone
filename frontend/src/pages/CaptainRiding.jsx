...
const CaptainRiding = () => {
    ...
    return (
        <div className='h-screen relative flex flex-col justify-end'>
            ...
            <div ref={finishRidePanelRef} className='fixed w-full z-[78] bottom-0 translate-y-full bg-white px-3 py-10 pt-12'>
                <FinishRide ride={rideData} setFinishRidePanel={setFinishRidePanel} />
            </div>
            <div className='h-screen fixed w-screen top-0 z-[-1]'><LiveTracking /></div>
        </div>
    )
}
